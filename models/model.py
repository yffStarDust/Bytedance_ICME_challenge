...
class RecommendModelHandler(object):
    ...
    def __init__(self, train_dataset_path, val_dataset_path, save_model_dir, learning_rate=0.1, num_threads=1, 
                 num_epochs=100, batch_size=40, embedding_size=100, optimizer='adam', task="finish", track=2):
        """ init basic params"""
